...
contract('ChainList', function(accounts){
  ...
  it("should buy an article", function() {
    return ChainList.deployed().then(function(instance) {
      chainListInstance = instance;
      // recrod balances of seller and buyer before the buy
      ...
      assert(buyerBalanceAfterBuy <= buyerBalanceBeforeBuy - articlePrice1, "buyer should have debited " + articlePrice1 + "ETH");
